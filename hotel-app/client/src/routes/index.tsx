    ...
    <section className='w-full h-full flex justify-center items-center'>
      <div className='w-full max-w-[80%] h-[calc(100vh-4rem)] flex justify-center items-center'>
        <div className='flex-1 flex flex-col gap-8'>
          <h1 className='text-4xl font-bold'><span className='bg-clip-text bg-gradient-to-r from-red-700 via-violet-700 to-orange-700  text-transparent'>Find Real Estate</span> <span className='text-red-700 text-5xl'>&</span> <span className='bg-clip-text bg-gradient-to-l from-cyan-500 to-red-700 text-transparent'>Get Your Dream Place</span></h1>
        ...
        <div className="relative w-64 h-full">
          ...
          <div className='w-full h-full absolute top-0 left-0 z-10'>
            <div className='absolute top-12 right-0 w-32 h-36 rounded-md border-2 border-slate-200'>
              <img src="/g-1.jpg" alt="gambar-1" className='w-full h-full object-cover rounded-md shadow-xl shadow-slate-900/70' loading='lazy' />
              </div>
            <div className='absolute bottom-12 left-1/2 -translate-x-1/2 w-40 h-32 rounded-lg border-2 border-slate-200'>
              <img src="/g-2.jpg" alt="gambar-2" className='w-full h-full object-cover rounded-lg  shadow-xl shadow-slate-900/70' loading='lazy' />
              </div>
            <div className='absolute bottom-1/2 righ-1/2 size-28 rounded-full border-2 border-slate-200'>
